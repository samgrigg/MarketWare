...
$(function() {
	(current_user == false) ? $("#demo-link").attr("href", "#user-form-box") : $("#demo-link").attr("href", "#demo-video");
	(current_user == false) ? $("#try-it-free-btn").attr("href", "#user-form-box") : $("#try-it-free-btn").attr("href", "http://marketware.com.s3.amazonaws.com/files/marketware_setup.exe");
...
function make_current_user() {
	...
	$("#try-it-free-btn").attr("href", "http://marketware.com.s3.amazonaws.com/files/marketware_setup.exe");
